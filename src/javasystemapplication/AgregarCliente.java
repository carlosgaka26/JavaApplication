...
public class AgregarCliente extends javax.swing.JFrame {
    ...
    private JTextField txtNombre, txtDomicilio, txtRFC;
    ...
    public AgregarCliente() {
        ...
        // 🔹 Eventos de botones
        btnGuardar.addActionListener(e -> confirmarYGuardarCliente());
 ...
 private void confirmarYGuardarCliente() {
        String nombre = txtNombre.getText().trim();
        String domicilio = txtDomicilio.getText().trim();
        String rfc = txtRFC.getText().trim();

        if (nombre.isEmpty() || domicilio.isEmpty() || rfc.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Todos los campos son obligatorios.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }

        // 🔹 Mostrar confirmación antes de guardar
        String mensaje = "¿Deseas guardar este cliente?\n\n" +
                         "📌 Nombre: " + nombre + "\n" +
                         "🏠 Domicilio: " + domicilio + "\n" +
                         "🆔 RFC: " + rfc;

        int confirmacion = JOptionPane.showConfirmDialog(this, mensaje, "Confirmar Datos", JOptionPane.YES_NO_OPTION);

        if (confirmacion == JOptionPane.YES_OPTION) {
            boolean resultado = clienteDAO.agregarCliente(nombre, domicilio, rfc);
            if (resultado) {
