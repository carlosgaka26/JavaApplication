...
public class PantallaInventario extends javax.swing.JFrame {
    ...
    public PantallaInventario() {
        setTitle("Totales de Inventario");
        setSize(800, 400);
        ...
        String[] columnas = {"Almacén", "Cliente", "Producto", "Presentación", "Total"};
        ...
        // 🔹 Crear tabla y agregarle el modelo
        tablaTotales = new JTable(modeloTabla);
        JScrollPane scrollPane = new JScrollPane(tablaTotales);
    ...
    private void cargarTotales() {
        ...
        List<String[]> totales = inventarioDAO.obtenerTotales();
